  ...
  return (
    <div className="flex-1 overflow-y-auto">
      ...
      <div className="px-4 mb-6">
        {loadingAwards ? (
          <div className="text-center py-8 text-muted-foreground text-sm flex flex-col items-center bg-card rounded-2xl border border-dashed">
            <Loader2 className="w-5 h-5 animate-spin mb-2 text-amber-500" /> Loading trophy room...
          </div>
        ) : (
          <TrophyShowcase awards={awards} />
        )}
      </div>
